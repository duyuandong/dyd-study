...
import com.spring.framework.context.support.ClassPathXmlApplicantionContext;
...
public class UserController {
    public static void main(String[] args) throws Exception {
       /* //1,创建spring容器对象
        ...
        ApplicationContext applicationContext = new ClassPathXmlApplicantionContext("applicationContext.xml");
        //2,从容器对象中获取userService对象
        UserService userService = applicationContext.getBean("userService", UserService.class);
        //3,调用userService方法进行业务逻辑处理
        userService.add();
